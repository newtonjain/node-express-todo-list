...
import { LoggingErrorReportingService, TelemetryErrorReportingService, CompositeErrorReportingService, PackageHelper } from '@glimpse/glimpse-node-common';
import { ModuleManager } from './tracing/ModuleManager';
import { createPackageRequiredBeforeInitError } from '@glimpse/glimpse-node-common';
import { ConfigSettings } from '@glimpse/glimpse-node-common';
import { getTelemetryConfig, TelemetryService, ITelemetryService, TelemetryEvents, GlimpseComponentType, getTelemetryAppInstanceData, IMeasurements, IProperties } from '@glimpse/glimpse-node-common';
...
class Agent implements IAgent {
    ...
    constructor() {
        ...
        this._telemetryService = new TelemetryService(GlimpseComponentType.NODE_AGENT, telemetryConfig);
    ...
    private sendAgentInitEvent() {
        ...
        const appData = getTelemetryAppInstanceData();
