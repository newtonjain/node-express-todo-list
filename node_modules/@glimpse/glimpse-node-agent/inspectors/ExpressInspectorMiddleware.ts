...
export class ExpressInspectorMiddleware {
    ...
    public init(broker: IAgentBroker, contextManager: IContextManager, dateTime: IDateTime) {
        ...
        Tracing.onAlways(EVENT_EXPRESS_INVOKE_PRE_ROUTE_METHOD, (event) => {
            this.onMiddlewareMethodInvoked(event.data.originalThis, event.data.originalArgs, event.data.methodName);
        });
    ...
    private onMiddlewareMethodInvoked(originalThis, originalArgs, method) {
    ...
    private wrapNestedMiddleware(array, paths: string[], method?: string) {
        for (let i = 0; i < array.length; i++) {
            ...
            if (typeof arg === 'function') {
                ...
                array[i] = MiddlewareWrapper.wrap(this.broker, this.contextManager, this.dateTime, paths, method, arg);
            }
