...
class AsyncTrack implements IAsyncTrack {
    ...
    private raiseWarning(msg: string) {
        // TODO: eventually hook this up to raise events so clients can report on errors.
        console.warn(msg);
    }
    ...
    private fatalError(msg) {
        ...
        this.raiseError(`async-track fatal error:  ${msg}`);
    ...
    private wrapCallback(callback, instrumentCBConfig, asyncId, asyncState, namepath: string[]) {
        ...
        if ((typeof callback) !== 'function') {
            this.fatalError(`callback ${callback} is not of type function.  Actual type is ${typeof callback}.`);
        }
