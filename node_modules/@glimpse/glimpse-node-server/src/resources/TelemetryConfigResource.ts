...
import { getTelemetryConfig } from '@glimpse/glimpse-node-common';
import { getTelemetryAppInstanceData } from '@glimpse/glimpse-node-common';
import { ITelemetryConfig } from '@glimpse/glimpse-node-common';
import { ITelemetryAppInstanceData } from '@glimpse/glimpse-node-common';
...
export class Resource implements IResource {
    ...
    public constructor(server: IServer) {
        ...
        this.appInstanceData = getTelemetryAppInstanceData();
