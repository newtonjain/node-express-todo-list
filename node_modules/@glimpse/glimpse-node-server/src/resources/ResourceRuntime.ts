import { IErrorReportingService, createAuthorizationInvocationFailedError } from '@glimpse/glimpse-node-common';
...
export class ResourceRuntime {
    public constructor(private resourceAuthorization: IResourceAuthorization, private resourceManager: IResourceManager, private errorReportingService: IErrorReportingService) {
    }

    public processRequest(req: express.Request, res: express.Response, next?: Function) {
