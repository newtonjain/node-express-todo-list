...
var setupProxy = function setupProxy() {
    ...
    http.createServer = function createServer(callback, ...args) {
        var app = buildApp(callback);
        return oldHttpCreateServer.call(this, app, ...args);
    };

    var oldHttpsCreateServer = https.createServer;
    https.createServer = function createServer(options, callback, ...args) {
        var app = buildApp(callback);
        return oldHttpsCreateServer.call(this, options, app, ...args);
    };
};
