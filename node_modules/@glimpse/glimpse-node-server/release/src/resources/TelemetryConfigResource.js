...
var Resource = (function () {
    function Resource(server) {
        ...
        this.uriTemplate = '';
        this.type = 'client';
        this.telemetryConfig = glimpse_node_common_1.getTelemetryConfig(server.providers.configSettings);
        this.appInstanceData = glimpse_node_common_2.getTelemetryAppInstanceData();
