...
var Resource = (function () {
    function Resource(server) {
        this.name = 'message-history';
        this.uriTemplate = '?types={types}';
        this.type = 'client';
        if (server) {
    ...
    Resource.prototype.invoke = function (req, res) {
        ...
        var messages = this.messageQuery.queryMessages(undefined, types);
...
//# sourceMappingURL=../../../maps/src/resources/MessageHistoryResource.js.map
